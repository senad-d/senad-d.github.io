...
# Run for passing thru all credentials
docker run -it --rm -v ~/.kube/config:~/.kube/config -v ~/.aws/config:~/.aws/config -v ${PWD}:/work -w /work --entrypoint /bin/sh amazon/aws-cli:2.0.43
