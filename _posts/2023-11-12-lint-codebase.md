    ...
    steps:
      ...
      - name: Lint Code Base
        ...
        env:
          ...
          DEFAULT_BRANCH: main
          GITHUB_TOKEN: '::escapeData::${{ secrets.GITHUB_TOKEN }}'
```
